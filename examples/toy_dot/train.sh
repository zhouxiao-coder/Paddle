...
PADDLE_TRAINER=/Users/zhouxiao1/code/github_code/Paddle/build2/opt/paddle/bin/paddle_trainer

#paddle train \
#gdb --args ${PADDLE_TRAINER} train \
#PYTHONPATH=/Users/zhouxiao1/code/github_code/Paddle/examples/toy_dot:${PYTHONPATH} gdb --args ${PADDLE_TRAINER} \
  #--job=train \
paddle train \
  --config=$cfg \
  --save_dir=${output_dir} \
